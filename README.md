# Cours bioinformatique session 2020
...
* Les numéros d'accession des variants majeurs connus (**Sud Africain, Britanique et Bresilien**) devront être representés sur votre arbre (au moins un individu par variant). Au besoin, vous devriez les (variants...) télécharger et les ajouter à votre jeu de donnée.
